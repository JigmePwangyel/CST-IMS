...
class ReEvalApplicationController(http.Controller):
    ...
    def _check_if_already_registered(self):
        ...
        re_register = (
            ...
            .sudo()
            .search(
                [("is_published", "=", True), ("type", "=", "reevaluation")], limit=1
            )
        )
        ...
        if existing_request:
            return request.render(
                "cst_result_processing_module_custom.already_applied_reeval_template",
    ...
    @http.route(
        "/student/re_eval_application/",
        type="http",
        auth="user",
        website=True,
    )
    def re_eval_application_form(self, **kwargs):
    ...
    # Submit Reevaluation form
    @http.route(
        "/student/reeval-application/submit",
        type="http",
        auth="public",
        website=True,
        methods=["POST"],
    ...
    def submit_re_eval_application(self, **post):
        ...
        if registar.is_published:
            ...
            products = self.get_fee_products("re_eval")
                    ...
                    .create(
                        {
                            ...
                            "invoice_origin": "Re-Evaluation Application",
            ...
            return request.render(
                "cst_result_processing_module_custom.thanks_reeval",
                {},
            )
    ...
    @http.route(
        "/student/my/reeval/application", type="http", auth="user", website=True
    )
    def view_my_re_eval_application(self, **kwargs):
        denied = self._check_student_group()
        if denied:
            return denied
        ...
        return request.render(
            "cst_result_processing_module_custom.view_my_re_eval_application",
